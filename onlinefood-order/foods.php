    ...
    <section class="food-menu">
        <div class="container">
            <h2 class="text-center" style="color:aliceblue">Food Menu</h2>
            <div class="filter">
            ...
            <button class=" button button3" onclick="window.location.href='<?php echo SITEURL; ?>foods.php'">Both</button>
            </div>
            <?php 
